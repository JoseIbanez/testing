...
aws s3 cp /mnt/tmp/stg/2016-09.tgz.gpg s3://kumo.fibratel.es/dev01/
aws s3 cp /mnt/tmp/stg/2016-08.tgz.gpg s3://kumo.fibratel.es/dev01/
aws s3 cp /mnt/tmp/stg/2016-07.tgz.gpg s3://kumo.fibratel.es/dev01/
aws s3 cp /mnt/tmp/stg/2016-06.tgz.gpg s3://kumo.fibratel.es/dev01/
